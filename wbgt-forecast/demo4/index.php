...
/* =========================
   VISUAL REDESIGN — LAYOUT ONLY
   ========================= */
:root{
  --bg:#f5f7fb; --surface:#ffffff; --surface2:#f8fafc;
  --ink:#172033; --muted:#68758b; --line:#e4e9f1;
  --navy:#101a35; --blue:#2563eb; --blue2:#eff6ff;
  --radius:16px; --shadow:0 8px 30px rgba(16,24,40,.06);
}
...
.navbar{
  ...
  background:rgba(16,26,53,.97)!important;
  border-bottom:1px solid rgba(255,255,255,.08);
  box-shadow:0 4px 20px rgba(16,26,53,.12);
}
.navbar .container-fluid{padding-left:24px!important;padding-right:24px!important}
.navbar-brand{font-size:1rem!important;letter-spacing:-.2px}
.navbar-nav .nav-link{font-size:.76rem!important;padding:.55rem .7rem!important;opacity:.82}
.navbar-nav .nav-link:hover{opacity:1}

.demo-ribbon{
  top:64px!important;height:34px;min-height:34px!important;
  background:#fff7ed!important;color:#9a3412!important;
  border-bottom:1px solid #fed7aa;
  box-shadow:none!important;text-transform:none!important;
  font-size:.69rem!important;letter-spacing:.2px!important;
}
.demo-ribbon i{color:#ea580c}

/* Hero becomes a clean dashboard header rather than a large banner */
.page-hero{
  margin:0 0 22px!important;
  border-radius:0!important;
  background:var(--surface)!important;color:var(--ink)!important;
  border-bottom:1px solid var(--line);
  box-shadow:none!important;padding:22px 0!important;
}
.hero-kicker{color:#64748b!important;opacity:1!important;font-size:.65rem!important}
.hero-title{color:var(--navy)!important;font-size:1.8rem!important;letter-spacing:-.7px}
.hero-sub{color:var(--muted)!important;font-size:.84rem}
.live-pill{
  background:var(--blue2)!important;color:#1d4ed8!important;
  border:1px solid #dbeafe!important;box-shadow:none!important;
}
.live-dot{background:#22c55e!important;box-shadow:none!important}
...
.stat-card:hover,.chart-wrapper:hover{
  transform:none!important;box-shadow:0 12px 36px rgba(16,24,40,.09)!important
}
.stat-card .card-body{padding:18px!important}
.stat-card .card-title{font-size:.67rem!important}
.stat-card .stat-number{font-size:1.75rem!important}
.stat-icon{font-size:1.55rem!important}

/* Main content cards */
.chart-wrapper{border:1px solid var(--line)!important;border-radius:var(--radius)!important;box-shadow:var(--shadow)!important;background:#fff!important}
.chart-wrapper,.card.stat-card{min-height:100%}
.section-head{padding-bottom:8px;border-bottom:1px solid #eef2f7;margin-bottom:12px!important}
.section-head h6{font-size:.82rem!important;color:var(--navy)}
.mini-select,.map-select,.map-control{
  border-color:#dfe5ee!important;border-radius:9px!important;
  box-shadow:none!important;font-size:.7rem!important
}

/* Map section gets more breathing room */
#ewarsMap{height:545px!important}
.map-shell{border:1px solid var(--line);background:#eef2f7}
.map-toolbar{top:12px!important;left:12px!important;right:12px!important}
.map-legend{
  left:12px!important;bottom:12px!important;
  border-radius:12px!important;box-shadow:0 8px 24px rgba(16,24,40,.10)!important
}
.map-layer-status{right:12px!important;bottom:12px!important}
.leaflet-control-zoom{border:0!important;box-shadow:0 5px 16px rgba(16,24,40,.12)!important}
.leaflet-control-zoom a{border:0!important;color:var(--navy)!important}

/* Alerts */
.alert-feed{padding-right:2px}
.alert-item{
  background:#fff!important;border:1px solid #e9edf3!important;
  border-left-width:3px!important;border-radius:11px!important;
  margin-bottom:8px!important;padding:10px!important
}
.alert-item:hover{transform:none!important;box-shadow:0 4px 16px rgba(16,24,40,.05)}
.alert-item .badge{font-size:.58rem}

/* Filter row */
.filter-bar{
  margin:4px 0 16px!important;padding:8px!important;
  border:1px solid var(--line)!important;border-radius:12px!important;
  box-shadow:none!important;background:#fff!important
}
.filter-btn{font-size:.68rem!important;padding:6px 11px!important}
.filter-btn.active{background:var(--navy)!important}

/* Tables */
.table-responsive{border:1px solid var(--line);border-radius:14px;overflow:hidden;background:#fff}
#alertTable{margin-bottom:0}
#alertTable th{font-size:.64rem!important;padding:11px!important}
#alertTable td{font-size:.75rem!important;padding:10px!important;border-color:#eef2f6}
#alertTable tbody tr:hover{background:#f8fafc}
.district-link{color:#1d4ed8!important}

/* Modal */
.modal-content{border:1px solid var(--line)!important;border-radius:18px!important;box-shadow:0 24px 70px rgba(15,23,42,.18)}
.detail-hero{border-radius:13px!important}
.detail-metric{border-radius:11px!important;background:#f8fafc!important}

/* Bottom demo notice */
.alert.alert-warning{
  background:#fffaf0!important;color:#7c4a03!important;
